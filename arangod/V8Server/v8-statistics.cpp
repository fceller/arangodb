...
static void FillDistribution(v8::Isolate* isolate, v8::Handle<v8::Object> list,
  ...
  result
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "sum"),
...
static void JS_ServerStatistics(
  ...
  result
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "physicalMemory"),
            v8::Number::New(isolate, (double)PhysicalMemory::getValue()))
      .FromMaybe(false);
  ...
  v8TransactionInfoObj
      ...
      .FromMaybe(false);
  v8TransactionInfoObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "aborted"),
            v8::Number::New(isolate, (double)ts._transactionsAborted.load()))
      .FromMaybe(false);
  v8TransactionInfoObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "committed"),
            v8::Number::New(isolate, (double)ts._transactionsCommitted.load()))
      .FromMaybe(false);
  v8TransactionInfoObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "intermediateCommits"),
  ...
  v8CountersObj
      ...
      .FromMaybe(false);
  v8CountersObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "dirty"),
            v8::Number::New(isolate, static_cast<uint32_t>(v8Counters.dirty)))
      .FromMaybe(false);
  v8CountersObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "free"),
            v8::Number::New(isolate, static_cast<uint32_t>(v8Counters.free)))
      .FromMaybe(false);
  v8CountersObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "max"),
            v8::Number::New(isolate, static_cast<uint32_t>(v8Counters.max)))
      .FromMaybe(false);
  v8CountersObj
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "min"),
  ...
  for (auto memStatistic : memoryStatistics) {
    ...
    v8MemStat
        ->Set(context, TRI_V8_ASCII_STRING(isolate, "contextId"),
              v8::Integer::New(isolate, static_cast<uint32_t>(memStatistic.id)))
        .FromMaybe(false);
    v8MemStat
        ->Set(context, TRI_V8_ASCII_STRING(isolate, "tMax"),
    ...
    v8MemStat
        ...
        .FromMaybe(false);
    v8MemStat
        ->Set(context, TRI_V8_ASCII_STRING(isolate, "heapMin"),
  ...
  counters
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "inProgress"),
            v8::Number::New(isolate, static_cast<int32_t>(qs._working)))
      .FromMaybe(false);

  counters
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "queued"),
...
static void JS_HttpStatistics(v8::FunctionCallbackInfo<v8::Value> const& args) {
  ...
  // request counters
  result
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "requestsTotal"),
  ...
  result
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "requestsUser"),
            v8::Number::New(isolate, (double)stats.totalRequestsUser.get()))
      .FromMaybe(false);
  result
      ->Set(context, TRI_V8_ASCII_STRING(isolate, "requestsAsync"),
            v8::Number::New(isolate, (double)stats.asyncRequests.get()))
      .FromMaybe(false);
  result
